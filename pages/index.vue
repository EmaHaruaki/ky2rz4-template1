							...
							<div class="entry-content">
								...
								<ul class="wp-block-gallery alignfull columns-3 is-cropped">
									<li class="blocks-gallery-item">
										<figure>
											<img src="https://ky2rz4.g.kuroco-img.app/files/user/img/fe4a5cbf.jpg?with=1280&height=708" alt="" class="wp-image-2298" width="1280" height="708"/>
										</figure>
									</li>
									<li class="blocks-gallery-item">
										<figure>
											<img src="https://ky2rz4.g.kuroco-img.app/files/user/img/jeff-sheldon-3219-unsplash.jpg?with=1280&height=960" alt="" class="wp-image-2298" width="1280" height="960"/>
										</figure>
									</li>
									<li class="blocks-gallery-item">
										<figure>
											<img src="https://ky2rz4.g.kuroco-img.app/files/user/img/jo-szczepanska-57782-unsplash.jpg?with=1280&height=853" alt="" class="wp-image-2298" width="1280" height="853"/>
										</figure>
									</li>
								</ul>
