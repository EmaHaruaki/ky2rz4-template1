				...
				<section id="primary" class="content-area">
					<main id="main" class="site-main">
						...
						<header class="page-header">
							<template v-for="n in res_tag.list" >
								<h1 :key="n.tag_id" v-if="n.tag_id == $route.params.slug" class="page-title">タグ: {{n.tag_nm}}</h1>
							</template>
						</header><!-- .page-header -->
...
<script>
	export default {
		async asyncData({ $axios, params }) {
			return { 
				res_list: await $axios.$get('/rcms-api/3/blog/list',{params:{cnt:100, tag_id:params.slug}}),
